    ...
    items: [
      {
        ...
        route: "/(main)/(ai)/chatbot",
      },
      {
        key: "foodscanner",
        label: "Food Scanner",
        icon: <ScanBarcode size={22} color="#6366f1" />,
        route: "/(main)/(ai)/food-scanner/food-scanner",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        route: "/(main)/(tracking)/tracker",
      },
      {
        key: "habits",
        label: "Habits",
        icon: <Repeat size={22} color="#06b6d4" />,
        route: "/(main)/(tracking)/habits",
      },
      {
        key: "form",
        label: "Form",
        icon: <ClipboardList size={22} color="#06b6d4" />,
        route: "/(main)/(tracking)/form",
      },
      {
        key: "analytics",
        label: "Analytics",
        icon: <BarChart2 size={22} color="#06b6d4" />,
        route: "/(main)/(tracking)/analytics",
      },
    ],
  },
  {
    ...
    items: [
      {
        key: "calculator",
        label: "Calculator",
        icon: <Calculator size={22} color="#f59e42" />,
        route: "/(main)/(nutrition)/diet-calculator",
      },
      {
        key: "mealplans",
        label: "Meal Plans",
        icon: <BookOpen size={22} color="#f59e42" />,
        route: "/(main)/(nutrition)/meal-plans",
      },
      {
        key: "recipes",
        label: "Recipes",
        icon: <BookOpen size={22} color="#f59e42" />,
        route: "/(main)/(nutrition)/recipes",
      },
      {
        key: "grocerylist",
        label: "Grocery List",
        icon: <ShoppingCart size={22} color="#f59e42" />,
        route: "/(main)/(nutrition)/grocery-list",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        route: "/(main)/(social)/forum",
      },
      {
        key: "blog",
        label: "Blog",
        icon: <MessageCircleMore size={22} color="#10b981" />,
        route: "/(main)/(social)/blog",
      },
      {
        key: "testimonials",
        label: "Testimonials",
        icon: <Star size={22} color="#10b981" />,
        route: "/(main)/(social)/testimonials",
      },
      {
        key: "chat",
        label: "Chat",
        icon: <MessageCircle size={22} color="#10b981" />,
        route: "/(main)/(social)/chat",
      },
    ],
  },
];
